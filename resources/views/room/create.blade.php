                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('room.store') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="type_room" name="type_room" class="form-control @error('type_room') is-invalid @enderror" value="{{ old('type_room') }}" required>
                            @error('type_room')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="facility" name="facility" class="form-control @error('facility') is-invalid @enderror" value="{{ old('facility') }}" required>
                            @error('facility')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        </div>
